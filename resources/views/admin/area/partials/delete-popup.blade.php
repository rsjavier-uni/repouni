<div class="modal-content col-md-5 col-lg-offset-3">
    <div class="modal-header">
        ...
        <h4 class="modal-title custom_align" id="Heading">Eliminar Area</h4>
    </div>
    {!! Form::open(array('route' => ['area.destroy',':area_ID'], 'id' => 'form-delete', 'class' =>'form-horizontal', 'method' =>'DELETE')) !!}
	    <div class="modal-body">
	       <div class="alert alert-danger"><span class="glyphicon glyphicon-warning-sign"></span> Desea Eliminar el Area <span id="area">/</span></div>
	    </div>
