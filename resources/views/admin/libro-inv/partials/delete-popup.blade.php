<div class="modal-content col-md-5 col-lg-offset-3">
    <div class="modal-header">
        ...
        <h4 class="modal-title custom_align" id="Heading">Eliminar Investigación</h4>
    </div>
    {!! Form::open(array('route' => ['libroinv.destroy',':libroinv_ID'], 'id' => 'form-delete', 'class' =>'form-horizontal', 'method' =>'DELETE')) !!}
      <div class="modal-body">
        <div class="alert alert-danger"><span class="glyphicon glyphicon-warning-sign"></span> Desea Eliminar la Investigación <span id="titulo">/</span></div>
      </div>
