<div class="modal-content col-md-5 col-lg-offset-3">
    <div class="modal-header">
        ...
        <h4 class="modal-title custom_align" id="Heading">Eliminar Rol de Usuario</h4>
    </div>
    {!! Form::open(array('route' => ['role.destroy',':rol_ID'], 'id' => 'form-delete', 'class' =>'form-horizontal', 'method' =>'DELETE')) !!}
	    <div class="modal-body">
	       <div class="alert alert-danger"><span class="glyphicon glyphicon-warning-sign"></span> Desea Eliminar el Rol <span id="role">/</span></div>
	    </div>
