...
<section id="main-content">
  <section class="wrapper">
  	 @can('usuario.edit')
        @if ($usuario_reg->id==Auth::user()->id||Auth::user()->isRole('super-usuario'))
		    <div class="row">
		      <div class="col-lg-8">
		        ...
		        <div class="row">
		          <div class="col-lg-8">
		            <section class="panel">
		              ...
		              {!! Form::model($usuario_reg,array('route' => ['usuario-reg.update',$usuario_reg->id],'role' => 'form', 'id' => 'usuarioRegisterForm', 'class' =>'form-validate form-horizontal', 'method' =>'PUT')) !!}
